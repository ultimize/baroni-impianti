...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        // Stessa meccanica di dialog.tsx e alert-dialog.tsx (data-open/data-closed
        // + animate-in/animate-out). Con data-starting-style/data-ending-style
        // l'attributo non veniva mai rimosso e overlay e pannello restavano a
        // opacity 0: il menu mobile si apriva invisibile.
